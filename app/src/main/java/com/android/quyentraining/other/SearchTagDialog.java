...
public class SearchTagDialog extends PopupWindow implements ItemFeedCallBack {
    ...
    public void setItemFeedTagClickListener(ItemFeedClickListener itemFeedClickListener) {
    ...
    public void OnCreate(Context context) {
        ...
        feedArrayList.add(AppConstain.POPULAR_UPPER);
        feedArrayList.add(AppConstain.NAME_TEXT_UPPER);
